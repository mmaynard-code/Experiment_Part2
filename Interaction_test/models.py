...
class Subsession(BaseSubsession):
    ...
    def do_my_shuffle(self):
        ...
        for p in self.get_players():
            p.participant.vars['issues_answers'] = numpy.random.randint(100, size=5)
            p.participant.vars['survey2_answers'] = [
                random.choice(["Problems around integration are mostly the fault of immigrants.", 
                "Problems around integration are mostly the fault of the society."]),
                random.choice(["We have to limit the influence of Islam in the world.", 
                "We have to allow the free spreading of the influence of Islam in the world."]),
                random.choice(["The expression of your religion, such as wearing a headcover or burkah, is not appropriate at the public domain, just at the private domain.", 
                "Everyone should be free to express his own religion also in his clothing at the public domain."]),
                random.choice(["The regulations of the government of my country concerning the spread of COVID-19 were not strict enough.", 
                "The regulations of the government of my country concerning the spread of COVID-19 were too strict."]),
                random.choice(["It is perfectly appropriate to use books, notes, and online help for an exam that is taking place online.", 
                "One should not use any help from books, notes, or from the Internet for making an exam that is taking place online."])
                ]
            p.participant.vars['surver3-6_answers'] = [
                random.choice(["E-sport", "Soccer (football)", "Car racing", "Figure skating", "Curling", "Darts", "I hate watching sports."]),
                random.choice(["Critical, quarrelsome", "Anxious, Easily upset", "Disorganized, careless", "Conventional, uncreative"]),
            ...
            p.participant.vars['meeting'] = p.participant.vars['surver3-6_answers'][2]
            p.participant.vars['give_money'] = random.randint(0,20)
